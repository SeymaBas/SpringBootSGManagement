...
public class TCKNValidator implements Validator {
    ...
    private static final FacesMessage ERROR_TCKN_NEGATIVE = new FacesMessage("negatif olamaz");
    private static final FacesMessage ERROR_TCKN_FORMAT = new FacesMessage("sayı(int) olmalıdır");
    private static final FacesMessage ERROR_TCKN_DIGIT = new FacesMessage("TCKN"+ TCKN_DIGIT+" haneli olmalıdır");
    private static final FacesMessage ERROR_TCKN_ALGORITM = new FacesMessage("TCKN algoritmasına uygun olmayan veri girilemez.");;
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
       ...
       long TCKN=Long.parseLong(strTCKN);
        ...
        else if(!Util.isValidTCKN(strTCKN))
        {
            ...
            throw new ValidatorException(ERROR_TCKN_ALGORITM);

        }


        }
        catch (NumberFormatException e){throw  new ValidatorException(ERROR_TCKN_FORMAT);}
